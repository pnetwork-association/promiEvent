...
declare type Resolve<T> = (value?: T | PromiseLike<T>) => void; // eslint-disable-line @typescript-eslint/no-unused-vars
declare type Reject = (reason?: any) => void; // eslint-disable-line @typescript-eslint/no-unused-vars
